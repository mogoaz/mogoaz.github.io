...
permalink: /projects/observability/
---
...
<section class="portfolio-section">
  ...
  <div class="portfolio-container">
    ...
    <p class="portfolio-description">
      ...
      Application and infrastructure monitoring work involving
      APM, dashboards, metrics, logs, alerting, and operational
      troubleshooting across production environments.
    ...
    <div class="portfolio-grid">
      ...
      <article class="portfolio-card">
        ...
        <p>
          ...
          using APM and real user monitoring data.
      ...
      <article class="portfolio-card">
        ...
        <p>
          ...
          Building dashboards and alerting rules to surface
      ...
      <article class="portfolio-card">
        ...
        <p>
          ...
          Using metrics, logs, and traces to diagnose and
    ...
    <div style="margin-top: 70px;">
      ...
      <div class="portfolio-tags">
        ...
        <span class="portfolio-tag">RUM</span>
    ...
    <div style="margin-top: 70px;">
      ...
      <p class="portfolio-description">
        ...
        This work sharpened my ability to correlate metrics,
